...
export const AlertIcon: React.FC<React.SVGAttributes<SVGElement>> = props => (
...
export const CheckIcon: React.FC<React.SVGAttributes<SVGElement>> = props => (
  <Svg {...getDefaultProps(12)} {...props}>
    <path fillRule="evenodd" d="M12 5.5l-8 8-4-4L1.5 8 4 10.5 10.5 4 12 5.5z" />
  </Svg>
);

export const FlameIcon: React.FC<React.SVGAttributes<SVGElement>> = props => (
  <Svg {...getDefaultProps(12)} {...props}>
    <path
      fillRule="evenodd"
...
export const InfoIcon: React.FC<React.SVGAttributes<SVGElement>> = props => {
  return (
